  ...
  <div>
   <div class="flex  items-center dark:text-slate-200 text-gray-900 justify-between p-6 lg:px-8">
      ...
      <div class="hidden md:flex md:flex-1 md:justify-end">
        ...
        <router-link to="/logowanie" class="text-md font-semibold leading-6">Zaloguj <span aria-hidden="true">&rarr;</span></router-link>
      </div>
    </div>
    <div v-show="menu" class="md:hidden text-gray-900 dark:text-slate-200">
      <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white dark:bg-neutral-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        <div class="flex items-center justify-between">
          <router-link to="/" class="-m-1.5 p-1.5"><img class="h-12 w-auto" src="../assets/logo.png"></router-link>
        ...
        <div class="mt-12 flow-root">
          <div class="-my-6 divide-y dark:divide-gray-600 divide-gray-600/10">
            ...
            <div class="py-2">
              <router-link @click="toggleMenu" to="/logowanie" class="-mx-3 block rounded-lg px-3 py-2.5 text-lg font-semibold leading-7 hover:bg-gray-50 dark:hover:bg-neutral-800">Zaloguj się</router-link>
            </div>
          </div>
        </div>
      </div>
